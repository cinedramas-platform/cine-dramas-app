    ...
    return (
      <View style={{ flex: 1, backgroundColor: Colors.bg }}>
        ...
        >
          ...
          {/* Top eyebrow */}
          <View style={{ position: 'absolute', top: insets.top + 40, left: 0, right: 0, alignItems: 'center' }}>
          ...
          {/* Bottom CTA */}
          <View style={{ position: 'absolute', left: 24, right: 24, bottom: insets.bottom + 40, gap: 10 }}>
            <Button label="Begin Reading" variant="accent" block height={52} onPress={advance} />
            <Pressable onPress={async () => { await markOnboarded(); router.replace('/auth/login'); }} style={{ alignItems: 'center', paddingTop: 4 }}>
    ...
    return (
      <View style={{ flex: 1, backgroundColor: Colors.bg, paddingTop: insets.top }}>
        ...
        <View style={{ paddingHorizontal: 22, paddingTop: 14, paddingBottom: 6 }}>
          ...
          <Text style={{ fontFamily: Fonts.sans, fontSize: 12, color: Colors.ink3, marginTop: 8, lineHeight: 18 }}>
            ...
            {MOODS.map((m) => {
              ...
              return (
                <Pressable
                  ...
                  style={{
                    width: MOOD_W, height: MOOD_H, borderRadius: Radius.lg, overflow: 'hidden',
                    position: 'relative',
                ...
                >
                  ...
                  <View style={{ position: 'absolute', bottom: 10, left: 12, right: 12 }}>
                    <Text style={{ fontFamily: Fonts.display, fontSize: 20, color: '#fff' }}>{m.label}</Text>
                  </View>
                  {selected && (
                    <View style={{
                      position: 'absolute', top: 8, right: 8, width: 22, height: 22, borderRadius: 22,
    ...
    <View style={{ flex: 1, backgroundColor: Colors.bg, paddingTop: insets.top }}>
      ...
      <View style={{ paddingHorizontal: 22, paddingTop: 30 }}>
        ...
        <View style={{
          ...
          backgroundColor: 'rgba(232,197,112,0.12)', borderWidth: 1, borderColor: 'rgba(232,197,112,0.3)',
        ...
        <Text style={{ fontFamily: Fonts.sans, fontSize: 13, color: Colors.ink2, marginTop: 12, lineHeight: 20, maxWidth: 320 }}>
          Get notified the moment new episodes of your saved series drop. Two pings a week. Never more.
        </Text>
      </View>
        ...
        <View style={{
          ...
          <View style={{ flex: 1, gap: 2 }}>
            ...
            <Text style={{ fontFamily: Fonts.sans, fontSize: 12, color: Colors.ink2, lineHeight: 17 }}>
              <Text style={{ fontFamily: Fonts.sans600, color: Colors.ink }}>Contracted to the CEO</Text> · EP 47 just dropped. The press conference is going to ruin them.
            </Text>
          </View>
        </View>
      </View>
