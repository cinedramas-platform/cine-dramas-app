...
import { WebContent, useContentWidth } from '@/lib/layout';
...
export default function PaywallScreen() {
  ...
  const SCREEN_W = useContentWidth(620);
      ...
      <WebContent max={620}>
        ...
        <View style={{ paddingHorizontal: 20, paddingTop: 18, paddingBottom: 12 }}>
          <View style={{ flexDirection: 'row', gap: 10 }}>
            ...
            >
              ...
              {['$4.99 one-time', 'Earn coins free', 'Ads remain', "Coins don't expire"].map(
                (f) => (
                  <View
                    key={f}
                    style={{ flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 6 }}
        ...
        <View style={{ paddingHorizontal: 20, paddingTop: 8, paddingBottom: 14 }}>
          ...
          >
            ...
            <Text
              style={{ fontFamily: Fonts.sans, fontSize: 10, color: Colors.ink3, marginTop: 4 }}
            >
