...
import { useContentWidth, useIsDesktopWeb } from '@/lib/layout';
...
export default function UnlockScreen() {
  ...
  const SCREEN_W = useContentWidth(480);
  const {
    episodeId,
    seriesId,
    seriesTitle = '',
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#000', alignItems: desktop ? 'center' : 'stretch' }}>
      <View style={{ flex: 1, width: desktop ? 480 : '100%', maxWidth: '100%' }}>
        ...
        {/* Episode header */}
        <View
          style={{ position: 'absolute', top: insets.top + 60, left: 20, right: 20, zIndex: 5 }}
        >
        ...
        {/* Teaser quote */}
        <View
          style={{ position: 'absolute', top: insets.top + 200, left: 20, right: 20, zIndex: 5 }}
        >
          <Text
            style={{
          ...
          >
            “She knew before the second bottle was poured. She just didn’t know which one of them
            had done it.”
          </Text>
